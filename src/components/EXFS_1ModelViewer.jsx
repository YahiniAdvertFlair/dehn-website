...
export default function EXFS_1ModelViewer({ modelPath, setActiveFeature, activeFeature }) {
  ...
  const hotspots = [
        { id: 1, name: "Lighting Protection", text: "⚡Isolating spark gap for hazardous areas",  hotspotPosition: { top: "5%", left: "74%" }, image: "/EXFS/EXFS_1.png" },
        { id: 2, name: "High Current Capacity", text: "⚡Withstands 100 kA (10/350 µs) lightning impulse current", hotspotPosition: { top: "15%", left: "85%" }, image: "/EXFS/EXFS_1.png" },
        { id: 3, name: "Low Sparkover Voltage", text: "📉 Ensures reliable equipotential bonding (≤ 1.25 kV)",hotspotPosition: { top: "32%", left: "80%" }, image: "/EXFS/EXFS_1.png" },
        { id: 4, name: "ATEX & IECEx Certified", text: "✅ Approved for Ex Zone 1 (Gas) & Zone 21 (Dust)", hotspotPosition: { top: "58%", left: "87%" }, image: "/EXFS/EXFS_1.png" },
        { id: 5, name: "Rugged and Waterproof", text: "IP67-rated for harsh environments",  hotspotPosition: { top: "73%", left: "78%" }, image: "/EXFS/EXFS_1.png" },
