...
export default function EXFS_1ModelViewer({ modelPath, setActiveFeature, activeFeature }) {
  ...
  const hotspots = [
        ...
        { id: 3, name: "Low Sparkover Voltage", text: "📉 Ensures reliable equipotential bonding (≤ 1.25 kV)",hotspotPosition: { top: "32%", left: "80%" }, image: "/assets/info.png" },
        { id: 4, name: "ATEX & IECEx Certified", text: "✅ Approved for Ex Zone 1 (Gas) & Zone 21 (Dust)", hotspotPosition: { top: "58%", left: "87%" }, image: "/assets/info.png" },
        ...
        { id: 6, name: "Versatile Installation", video: "/EXFS/EXFS_1_feature.webp", hotspotPosition: { top: "92%", left: "82%" }, image: "/assets/info.png" }
      ];
