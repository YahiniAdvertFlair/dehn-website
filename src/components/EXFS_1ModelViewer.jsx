...
export default function EXFS_1ModelViewer({ modelPath, setActiveFeature, activeFeature }) {
  const { activeFeatureModels, setActiveFeatureModel } = useProductStore();
  const activeModel = activeFeatureModels[6] ?? modelPath;
  ...
  const hotspots = [
        { id: 1, name: "Lighting Protection", text: "⚡Isolating spark gap for hazardous areas",  hotspotPosition: { top: "10%", left: "75%" }, image: "/EXFS/EXFS_1.png" },
        { id: 2, name: "High Current Capacity", text: "⚡Withstands 100 kA (10/350 µs) lightning impulse current", hotspotPosition: { top: "15%", left: "89%" }, image: "/EXFS/EXFS_1.png" },
        { id: 3, name: "Low Sparkover Voltage", text: "📉 Ensures reliable equipotential bonding (≤ 1.25 kV)",hotspotPosition: { top: "60%", left: "88%" }, image: "/EXFS/EXFS_1.png" },
        { id: 4, name: "ATEX & IECEx Certified", text: "✅ Approved for Ex Zone 1 (Gas) & Zone 21 (Dust)", hotspotPosition: { top: "65%", left: "77%" }, image: "/EXFS/EXFS_1.png" },
        { id: 5, name: "Rugged and Waterproof", text: "IP67-rated for harsh environments",  hotspotPosition: { top: "85%", left: "75%" }, image: "/EXFS/EXFS_1.png" },
        { id: 6, name: "Versatile Installation", video: "/EXFS/EXFS_1_feature.webp", hotspotPosition: { top: "92%", left: "82%" }, image: "/EXFS/EXFS_1.png" }
      ];
  ...
  return (
    ...
    {isVideoActive && (
        <div className="absolute flex flex-col items-center bg-dehn-eerieblack bg-opacity-80 p-4 rounded-lg shadow-lg z-40">
         ...
         <img src="/EXFS/EXFS_1_feature.webp" alt="backup-fuse" className="w-100 h-60" />
          <button
